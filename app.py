...
def ChatModel(temperature, top_p):
    return AutoModelForCausalLM.from_pretrained(
        'https://huggingface.co/TheBloke/Llama-2-7B-Chat-GGML/tree/main/llama-2-7b-chat.ggmlv3.q5_0.bin', 
        model_type='llama',
...
if "messages" not in st.session_state.keys():
    st.session_state.messages = [{"role": "assistant", "content": "Arambikalama! How may I assist you today?"}]
